        ...
        <RNSafeAreaView style={{
            ...
            >
                {subjectsArray.map((subject: any, index: number) => {
                    ...
                    return (
                        <View key={subject._id} style={{ marginBottom: screenWidth * 0.04 }} className='w-full'>
                            <TouchableOpacity 
                                className={`${cardStyle} rounded-[20px]`}
                                style={{
                                    borderWidth: 3,
                            ...
                            >
                                <View className='flex-row items-center'>
                                    ...
                                    <View className='flex-1 ml-4'>
                                        <Text className='text-base font-extrabold text-white'>{subject.name}</Text>
